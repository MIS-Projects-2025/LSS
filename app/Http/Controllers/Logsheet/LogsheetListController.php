...
class LogsheetListController extends Controller
{
    protected $datatable;
    ...
    public function index(Request $request)
    {
        ...
        $result = $this->datatable->handle(
            ...
            [
                ...
                'searchColumns' => ['lot_id', 'package_type', 'requirement', 'lot_quantity', 'sample_size', 'employee_name', 'stamp_no', 'inspection_result'],
            ]
        );
        ...
        return Inertia::render('Logsheet/LogsheetMonitoringList', [
    ...
    public function editseses(Request $request, $id)
    {
        $data = $request->validate([
            ...
            'type_of_defect' => 'nullable|string|max:255',
            'no_of_defect' => 'nullable|string|max:255',
        ...
        return redirect()->route('inspection.logsheet.list')->with('success', 'Logsheet item updated successfully');
    }
